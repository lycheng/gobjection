...
func TestIterator(t *testing.T) {
	...
	iter := a.Iterator()
	if iter.Next() != 1 {
		t.Error("iterator return not equals to 1")
	}
	if iter.Next() != 2 {
		t.Error("iterator return not equals to 2")
	}
	if iter.Next() != 3 {
		t.Error("iterator return not equals to 3")
	}
	if iter.Next() != nil {
		t.Error("iterator return not equals to nil")
	}
}

func TestReverseIterator(t *testing.T) {
	a := New(1, 2, 3)
	iter := a.ReverseIterator()
	if iter.Next() != 3 {
		t.Error("reverse iterator return not equals to 3")
	}
	if iter.Next() != 2 {
		t.Error("reverse iterator return not equals to 2")
	}
	if iter.Next() != 1 {
		t.Error("reverse iterator return not equals to 1")
	}
	if iter.Next() != nil {
		t.Error("reverse iterator return not equals to nil")
	}
}
